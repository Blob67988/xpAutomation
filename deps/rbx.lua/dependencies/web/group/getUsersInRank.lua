...
function module.run(authentication,groupId,roleid)
	local endpoint = "https://groups.roblox.com/v1/groups/"..groupId.."/roles/"..roleid.."/users?sortOrder=Asc&limit=100";
	...
	if(response.code == 200) then 
		local pageClass = function(body)
			...
			function methods.isFinalPage()
				return internal.pointers.nextCursor ~= nil 
			end
