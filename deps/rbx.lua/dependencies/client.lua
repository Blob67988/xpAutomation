...
return function(configuration)
	...
	local search = {
		user = {"getImage","getTransactionHistory","acceptFriendRequest","getRobuxAmount","blockUser","currentAuthenticated","declineAllFriendRequests","declineFriendRequest","followUser","getDescription","getFollowerCount","getFollowersList","getFollowingCount","getFollowingList","getFriendRequestAmount","getFriendRequestList","getFriendsCount","getFriendsList","getGroups","getOnlineFriends","getPastNames","getStatus","getUser","searchUsernames","sendFriendRequest","setStatus","unfollowUser"},
		group = {"getUsersInRank","getRole","getRank","getGroup","getRevenue","getSales","getRobuxAmount","payout","acceptJoinRequest","declineJoinRequest","deleteWallPost","deleteWallPostsByUser","exileUser","getAuditLogs","getJoinRequests","getRoleId","getRoles","getUsers","getWall","rankUser","shout","updateDescription"},
